...
<body class="w3-content" style="max-width: 1200px">
	...
	<div class="w3-container w3-display-container w3-padding-16">
		...
		<h3 class="w3-wide">
			<b><a href="../profile/profileopen">${LOGGED_IN_USER.name}</a></b>
		</h3>
	</div>
		...
		<div class="w3-row w3-grayscale">
			<div class="w3-col l3 s6">
				<div class="w3-container">
					<img src="../assests/images/python.jpg" style="width: 100%"><br>
					<p>
						Python- <b>$24.99</b>
					</p>
				</div>
				<div class="w3-container">
					<img src="../assests/images/jscript.png" style="width: 100%"><br>
					<p>
						Java Script<br>
						<br> <b>$19.99</b>
					</p>
			...
			<div class="w3-col l3 s6">
				...
				<div class="w3-container">
					<img src="../assests/images/cpp.jpg" style="width: 100%"><br>
					<p>
						C++<br> <b>$20.50</b>
					</p>
				</div>
			...
			<div class="w3-col l3 s6">
				...
				<div class="w3-container">
					<div class="w3-display-container">
						<img src="../assests/images/st.jpg" style="width: 100%"><br> <span
					...
					<p>
						Software Testing<br> <b class="w3-text-red">$14.99</b><br>
					</p>
				</div>
			</div>
